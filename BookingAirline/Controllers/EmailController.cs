...
namespace BookingAirline.Controllers
{
    public class EmailController : Controller
    {
        ...
        public ActionResult SendEmail(string useremail)
        {
            ...
            string body = "Xin chào bạn <h1>Nguyễn Thị Diễm Quỳnh </h1>bạn vừa đặng nhập vào trang web tội phạm , Nếu không phải là bạn vui lòng cung cấp thông tin của bạn tại https://luatduonggia.vn/cach-lam-don-gui-don-to-cao-online-qua-mang-moi-nhat/. !";
