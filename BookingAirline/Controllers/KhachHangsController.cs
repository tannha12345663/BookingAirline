...
namespace BookingAirline.Controllers
{
    public class KhachHangsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IDKH,MaLKH,UserName,Password,TenKH,SDT,Email,GioiTinh,NgaySinh")] KhachHang khachHang)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IDKH,MaLKH,UserName,Password,TenKH,SDT,Email,GioiTinh,NgaySinh")] KhachHang khachHang)
        {
            if (ModelState.IsValid)
            {
